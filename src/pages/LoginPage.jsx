    ...
    <div className={styles.page}>
      ...
      <div className={styles.card}>
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>Sign in to continue to IdeaVault</p>
        </div>

        <button type="button" onClick={handleGoogle} className={styles.googleBtn} id="google-login-btn">
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          <div className="form-group">
            ...
            <div className={styles.inputWrap}>
              ...
              <input id="login-email" name="email" type="email" className={`form-control ${styles.inputPadded}`}
